...
//ALGUEM TROCA ESSA FONTE PELO AMOR DE DEUS
function Profile() {
    return (
        <>
                    ...
                    <div className="w-full rounded-t-lg h-16 bg-gradient-to-r from-[#4485E7] to-[#8F8F8F] "></div>
                        <div id="container" className="pr-6 pl-6 ">
                            <div className="flex flex-row w-full mt-4">
                                ...
                                <button className="text relative top-4 left-[400px] font-['Poppins',_sans-serif] w-[120px] bg-sky-500 text-white rounded-[9px] mt-3 text-[15px] h-[40px]"                                >Editar</button>
                        </div>
                        <div className="mt-6 grid gap-4 grid-cols-2">
                                <div className="flex flex-col">
                                    <label className="text-[#555555] text-left self-start text-base font-normal">Nome Completo</label>
                                    <input placeholder="Nome Completo" disabled className="bg-[#eaeaea] border-0 rounded-md h-10" type="text" />
                                </div>
                                <div className="flex flex-col">
                                    <label className="text-[#555555] text-left self-start text-base font-normal">Sua Senha</label>
                                    <input placeholder="*************" disabled className="bg-[#eaeaea] border-0 rounded-md h-10" type="password" />
                                </div>
                            </div>
                        <div className="mt-6 grid gap-4 grid-cols-2">
                                <div className="flex flex-col">
                                    <label className="text-[#555555] text-left self-start text-base font-normal">Tipo Juridico</label>
                                    <select className="bg-[#eaeaea] border-0 rounded-md h-10" name="" id="">
