...
function signupLawyer() {
    ...
    <div className="text-center h-[85vh] text-[30px]" >
        ...
        <h2 className="text font-['Poppins',_sans-serif] text-[15px] mt-3 text-gray-600">Nome Completo</h2>
            ...
            <input className="input rounded-lg border-none bg-[#e6ebf3] w-[410px] text font-['Poppins',_sans-serif] text-[15px]" type="email" placeholder="Seu Email"/>
            <h2 className="text font-['Poppins',_sans-serif] text-[15px] mt-3 text-gray-600">Senha</h2>
            <input className="input rounded-lg border-none bg-[#e6ebf3] w-[410px] text font-['Poppins',_sans-serif] text-[15px]" type="password" placeholder="Sua Senha"/>

            <h2 className="text font-['Poppins',_sans-serif] text-[15px] mt-3 text-gray-600">Numero da OAB</h2>
            <input className="input rounded-lg border-none bg-[#e6ebf3] w-[410px] text font-['Poppins',_sans-serif] text-[15px]" type="text" placeholder="UF999999"/>
        ...
        <h2></h2>
        <button type="submit" className="text font-['Poppins',_sans-serif] w-[265px] bg-[#1557BB] text-white rounded-[9px] mt-3 text-[15px] h-[40px]">Continuar</button>
        </form>
    </div>
    </>)
}

signupLawyer.layout = page => <Layout children={page} title={'SignIn'} fixedStatus={true} />
